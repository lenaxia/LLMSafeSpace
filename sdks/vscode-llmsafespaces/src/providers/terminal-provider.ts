...
export function registerTerminalCommand(context: vscode.ExtensionContext, api: ApiService) {
  return vscode.commands.registerCommand("llmsafespaces.openTerminal", async (item: any) => {
    ...
    await vscode.window.withProgress(
      ...
      async () => {
        try {
          ...
          const apiUrl = vscode.workspace.getConfiguration("llmsafespaces").get<string>("apiUrl") || "";
