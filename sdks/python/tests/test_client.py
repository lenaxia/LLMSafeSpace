"""Unit tests for LLMSafeSpace Python SDK."""

import pytest
import httpx
import respx

from llmsafespace import LLMSafeSpace, NotFoundError, AuthError, TimeoutError, MessageResponse
...
def test_list_workspaces():
    ...
    client = LLMSafeSpace("http://localhost:8080", api_key="lsp_test")
...
def test_auth_error():
    ...
    client = LLMSafeSpace("http://localhost:8080", api_key="lsp_bad")
...
def test_api_key_header():
    ...
    client = LLMSafeSpace("http://localhost:8080", api_key="lsp_mykey")
    client.auth.me()
...
def test_auto_login_with_credentials():
    ...
    client = LLMSafeSpace("http://localhost:8080", email="test@example.com", password="pass123")
