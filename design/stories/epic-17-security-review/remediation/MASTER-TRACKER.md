...
| F1.2.3 | Spec.Resources.* not applied to pod | High | MINE — code-fix landed worklog 0108, awaiting live re-pentest | controller pod-spec generation |
...
| F1.2.5 | Spec.Packages[].Requirements[] shell injection | High | MINE — code-fix landed worklog 0108, awaiting live re-pentest | controller package init container |
