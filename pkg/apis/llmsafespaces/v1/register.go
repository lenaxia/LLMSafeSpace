...
const (
	// GroupName is the group name for LLMSafeSpaces CRDs.
	GroupName = "llmsafespaces.dev"
	// GroupVersion is the version for LLMSafeSpaces CRDs.
	GroupVersion = "v1"
)
...
//
//	v1.ListOptions is not suitable for converting to "llmsafespaces.dev/v1"
//
