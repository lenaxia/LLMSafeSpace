...
func InstanceSettings() []SettingDef {
	return []SettingDef{
		...
		{Key: "workspace.defaultStorageSize", Tier: 2, Type: TypeString, Default: "1Gi", Pattern: `^[0-9]+(Gi|Mi)$`, Category: "Workspace", Label: "Default Storage", Description: "Default PVC size"},
