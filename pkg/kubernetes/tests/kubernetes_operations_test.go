		...
		Files: []types.FileInfo{
			{
				...
				Size:      1024,
				IsDir:     false,
				CreatedAt: metav1.NewTime(metav1.Now().Add(metav1.Duration{Duration: metav1.Duration{Duration: -1 * time.Hour}})),
				UpdatedAt: metav1.NewTime(metav1.Now().Add(metav1.Duration{Duration: -30 * time.Minute})),
			},
			{
				Path:      "/workspace/data",
				Name:      "data",
				Size:      4096,
				IsDir:     true,
				CreatedAt: metav1.NewTime(metav1.Now().Add(metav1.Duration{Duration: metav1.Duration{Duration: metav1.Duration{Duration: -2 * time.Hour}}})),
