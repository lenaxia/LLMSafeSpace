...
// ModelConfigTable renders the editable checkbox + context-window table used by
// the provider-credential forms to pick an allowlist and per-model context
// limits. It is a pure presentational component with no API or store
