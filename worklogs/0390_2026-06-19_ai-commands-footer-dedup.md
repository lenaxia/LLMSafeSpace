...
- Follow-up (worklog 0391): add `/design` and `/merge` commands and a `--no-merge` hold flag to the code-change commands.
...
- `worklogs/0390_2026-06-19_ai-commands-footer-dedup.md` (new — this file)
